...
const actions = {
  async getDeputy ({commit, state}, payload) {
    ...
    const result = await axios.post('/dods/services/public/api/deputy/district/search', payload)
  ...
  async deleteDeputy ({commit, state}, payload) {
    const result = await axios.get('/dods/services/public/api/deputy/district/delete/'+payload )
  ...
  async updateDeputy ({commit, state}, payload) {
    ...
    const result = await axios.post('/dods/services/public/api/deputy/district/update', formData)
    if (result.data.status === true) {
  ...
  async createDeputy ({commit, state}, payload) {
    ...
    const result = await axios.post('/dods/services/public/api/deputy/district', formData)
    if (result.data.status === true) {
